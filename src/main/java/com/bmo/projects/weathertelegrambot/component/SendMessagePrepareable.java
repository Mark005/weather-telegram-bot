...
import com.bmo.projects.weathertelegrambot.component.keyboard.PrepareableReplyKeyboard;
...
@AllArgsConstructor
@Builder
public class SendMessagePrepareable extends PrepareableBotApiMethod<Message> {
    ...
    @JsonDeserialize()
    private PrepareableReplyKeyboard replyMarkup; ///< Optional. JSON-serialized object for a custom reply keyboard
    ...
    public void prepare(WeatherBot bot, Update update) {
        replyMarkup.prepare(bot, update);
    }
